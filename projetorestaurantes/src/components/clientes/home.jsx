...
import { Modal, ModalContent, CloseButton, StepButton, HorarioButton, MenuList, MenuCard, MenuImage, MenuDetails, MenuTitle, MenuDescription, MenuPrice, SelectMenuButton, NavigationContainer, NavigationArrow,
                    ...
                    <ModalContent>
                        ...
                        {currentStep === 1 && (
                            ...
                            <ProgressBar>
                                ...
                                required
                                />
                                <StepButton onClick={handleNextStep}>Próximo</StepButton>
                            </>
                        )}
                        ...
                        {currentStep === 2 && (
                            ...
                            <ProgressBar>
                                ...
                                />
                                <StepButton onClick={handlePrevStep}>Voltar</StepButton>
                                <StepButton onClick={handleNextStep}>Próximo</StepButton>
                            </>
                        )}
                            ...
                            <ProgressBar>
                                ...
                                <MenuList>
                                    {menus.map(menu => (
                                        ...
                                        >
                                            {selectedMenuIds.includes(menu.id_menu) ? 'Remover' : 'Selecionar'}
                                        </SelectMenuButton>
                                        </MenuCard>
                                    ))}
                                </MenuList>
